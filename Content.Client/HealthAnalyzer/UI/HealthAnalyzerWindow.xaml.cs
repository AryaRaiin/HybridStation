...
namespace Content.Client.HealthAnalyzer.UI
{
    ...
    public sealed partial class HealthAnalyzerWindow : FancyWindow
    {
        ...
        public void Populate(HealthAnalyzerScannedUserMessage msg)
        {
            ...
            if (target == null
                || !_entityManager.TryGetComponent<DamageableComponent>(isPart ? part : target, out var damageable))
            {
                NoPatientDataText.Visible = true;
                return;
            }

            SetActiveButtons(_entityManager.HasComponent<TargetingComponent>(target.Value));
            ...
            SpriteView.SetEntity(SetupIcon(msg.Body) ?? target.Value);
