...
public abstract partial class SharedSalvageSystem : EntitySystem
{
    ...
    {
        // FRONTIER: Hardcoded in coooooz it's dynamic based on difficulty and I'm lazy.
...
// FRONTIER END
    public SalvageMission GetMission(SalvageMissionType config, DifficultyRating difficulty, int seed) // FRONTIER: OVERRIVDE SalvageDifficultyPrototype, ADD SalvageMissionType and DifficultyRating
    {
        ...
        var biome = GetMod<SalvageBiomeModPrototype>(rand, ref rating); // FRONTIER
        var air = GetBiomeMod<SalvageAirMod>(biome.ID, rand, ref rating); // FRONTIER
        var dungeon = GetBiomeMod<SalvageDungeonModPrototype>(biome.ID, rand, ref rating); // FRONTIER
