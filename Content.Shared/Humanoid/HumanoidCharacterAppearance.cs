...
public sealed partial class HumanoidCharacterAppearance : ICharacterAppearance, IEquatable<HumanoidCharacterAppearance>
{
    ...
    [DataField]
    public float Height { get; set; } = 1.0f; // UNKNOWN

    [DataField]
    public float Width { get; set; } = 1.0f; // UNKNOWN
    ...
    public HumanoidCharacterAppearance(string hairStyleId,
        ...
        float height = 1.0f, // UNKNOWN
        float width = 1.0f) // UNKNOWN
    {
        ...
        Markings = markings;
        Height = height <= 0.005f ? 1.0f : height; // UNKNOWN
        Width = width <= 0.005f ? 1.0f : width; // UNKNOWN
    }
    ...
    public HumanoidCharacterAppearance(HumanoidCharacterAppearance other) :
        this(other.HairStyleId, other.HairColor, other.FacialHairStyleId, other.FacialHairColor, other.EyeColor, other.SkinColor, new(other.Markings),
         other.Height, other.Width) // UNKNOWN
    {
    ...
    public static HumanoidCharacterAppearance Random(string species, Sex sex)
    {
        ...
        var newHeight = random.NextFloat(0.95f, 1.05f); // UNKNOWN: Random height between 95% and 105% of normal
        var newWidth = random.NextFloat(0.95f, 1.05f); // UNKNOWN: Random width between 95% and 105% of normal
        return new HumanoidCharacterAppearance(newHairStyle, newHairColor, newFacialHairStyle, newHairColor, newEyeColor, newSkinColor, new(),
            newHeight, newWidth);// UNKNOWN
    ...
    public static HumanoidCharacterAppearance EnsureValid(HumanoidCharacterAppearance appearance, string species, Sex sex)
    {
        ...
        return new HumanoidCharacterAppearance(
            ...
            appearance.Height, // UNKNOWN
            appearance.Width); // UNKNOWN
    }
    ...
    public bool MemberwiseEquals(ICharacterAppearance maybeOther)
    {
        ...
        if (!Height.Equals(other.Height)) return false; // UNKNOWN
        if (!Width.Equals(other.Width)) return false; // UNKNOWN
        return true;
    }
    ...
    public bool Equals(HumanoidCharacterAppearance? other)
    {
        ...
        return HairStyleId == other.HairStyleId &&
               ...
               Height.Equals(other.Height) && // UNKNOWN
               Width.Equals(other.Width); // UNKNOWN
    }
    ...
    public override int GetHashCode()
    {
        return HashCode.Combine(HairStyleId, HairColor, FacialHairStyleId, FacialHairColor, EyeColor, SkinColor, Markings,
            HashCode.Combine(Height, Width)); // UNKNOWN
    }
