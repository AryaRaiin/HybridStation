...
namespace Content.Shared.Containers.ItemSlots
{
    ...
    public sealed partial class ItemSlotsSystem : EntitySystem
    {
        ...
        private void OnInteractUsing(EntityUid uid, ItemSlotsComponent itemSlots, InteractUsingEvent args)
        {
            ...
            if (_handsSystem.IsHolding(args.User, args.Used) &&
                !_handsSystem.TryDrop(args.User, args.Used)) // Goobstation - don't try to drop if not holding
                return;
            ...
            bool excludeUserAudio = false)
        {
            ...
            /* FRONTIER START - disable upstream, rewrite below
