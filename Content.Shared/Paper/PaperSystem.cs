...
public sealed class PaperSystem : EntitySystem
{
    ...
    private void OnExamined(Entity<PaperComponent> entity, ref ExaminedEvent args)
    {
        ...
        using (args.PushGroup(nameof(PaperComponent)))
        {
            ...
            {
                /* // Frontier: disable upstream method
                var commaSeparated =
                ...
                */
                // Frontier START - Make stamps and signatures render separately.
    ...
    private void OnInteractUsing(Entity<PaperComponent> entity, ref InteractUsingEvent args)
    {
        ...
        if (_tagSystem.HasTag(args.Used, WriteTag))
        {
            if (editable)
            {
                ...
                UpdateUserInterface(entity);
                args.Handled = true; // Frontier: moved from below
                return;
            }
            // Frontier: move above
            //args.Handled = true;
        ...
        {
            // Frontier START: assign DisplayStampInfo before stamp
            ...
            // Frontier START: stamp delay and protection
