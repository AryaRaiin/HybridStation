...
public sealed class RandomSentienceRule : StationEventSystem<RandomSentienceRuleComponent>
{
    ...
    protected override void Started(EntityUid uid, RandomSentienceRuleComponent component, GameRuleComponent gameRule, GameRuleStartedEvent args)
    {
        ...
        if (!TryGetRandomStations(gameRule.NumberOfGrids.Min, gameRule.NumberOfGrids.Max, out var stations)) // Mono change: multiple stations
            return;
        ...
        while (query.MoveNext(out var targetUid, out var target, out var xform))
        {
            ...
            var owningStation = StationSystem.GetOwningStation(targetUid, xform); // Mono change: multiple stations
        ...
        foreach (var station in stations) // Mono change: multiple stations
        {
