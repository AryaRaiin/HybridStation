...
using Content.Shared._Goobstation.Weapons.SmartGun; // goobstation
using Content.Shared.Wieldable.Components; // goobstation
...
public sealed partial class NPCCombatSystem
{
    ...
    private void UpdateRanged(float frameTime)
    {
        ...
        {
            //Goobstation START: moved from below
