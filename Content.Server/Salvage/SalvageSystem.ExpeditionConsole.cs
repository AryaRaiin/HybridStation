...
public sealed partial class SalvageSystem
{
    ...
    private const float ShuttleFTLRange = 256f; // Frontier?
    private const float ShuttleFTLMassThreshold = 100f; // Frontier?
        ...
        EntityUid stationUid) // Frontier
    {
        ...
        while (query.MoveNext(out var uid, out _, out var uiComp, out var xform))
        {
            ...
            if (station != stationUid) // Frontier
                continue;
