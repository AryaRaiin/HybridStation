...
public sealed partial class BodySystem : SharedBodySystem // Shitmed change: made partial
{
        ...
        string slotId)
    {
        ...
        if (layer != null)
        {
            ...
            _humanoidSystem.SetLayersVisibility( bodyEnt.Owner, 
                    new[] { layer.Value }, //Shitmed Change?
                    visible: true);
        }
    }
    ...
    public override HashSet<EntityUid> GibBody(
        ...
        GibType gib = GibType.Gib, // Shitmed
        GibContentsOption contents = GibContentsOption.Drop) // Shitmed
    {
