...
namespace Content.Server.Chemistry.EntitySystems
{
    ...
    public sealed class ReagentDispenserSystem : EntitySystem
    {
        ...
        public override void Initialize()
        {
            ...
            SubscribeLocalEvent<ReagentDispenserComponent, EntInsertedIntoContainerMessage>(OnEntInserted, after: [typeof(SharedStorageSystem)]); // Frontier: SubscribeUpdateUiState -> OnEntInserted
        ...
        // Frontier START: auto-label on insert
        ...
        private void OnMapInit(Entity<ReagentDispenserComponent> ent, ref MapInitEvent args)
        {
            ...
            // Frontier START: spawn slot contents
        ...
        // Frontier START: upgradable parts
